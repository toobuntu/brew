...
__fish_brew_complete_arg 'tap-new' -l bot-email -d 'Commit email for the automated bump bot, e.g. "12345+bot@users.noreply.github.com" (used in autobump.yml)'
__fish_brew_complete_arg 'tap-new' -l bot-username -d 'GitHub username for the automated bump bot (used in autobump.yml)'
...
__fish_brew_complete_arg 'tap-new' -l cask -d 'Generate cask tap scaffolding (Casks/ directory, cask CI workflows)'
__fish_brew_complete_arg 'tap-new' -l debug -d 'Display any debugging information'
__fish_brew_complete_arg 'tap-new' -l formula -d 'Explicitly generate formula tap scaffolding (Formula/ directory, bottle workflows). This is the default if neither `--formula` nor `--cask` is specified'
...
__fish_brew_complete_arg 'tap-new' -l pull-label -d 'Label name for pull requests ready to be pulled. When a PR with this label is created, the `publish.yml` workflow triggers `brew pr-pull` to merge bottles into the tap (default: `pr-pull`). Only used for formula taps'
